...
-   Charts and tables should be referenced text. Specific guidelines are provided in tutorial on the report format. This matters both for readability and apparently is a quarto quirk with `{tinytable}` package used for rendering tables.

-   We do not use titles for plots.